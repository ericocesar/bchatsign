# Contributing to Bchatsign

If you plan to contribute to Bchatsign, please take a moment to feel awesome ✨ People like you are what open source is about ♥. Any contributions, no matter how big or small, are highly appreciated.

## Before getting started

- Before jumping into a PR be sure to search [existing PRs](https://github.com/bchatsign/bchatsign/pulls) or [issues](https://github.com/bchatsign/bchatsign/issues) for an open or closed item that relates to your submission.
- Select an issue from [here](https://github.com/bchatsign/bchatsign/issues) or create a new one
...
3. See the [Developer Setup](https://github.com/bchatsign/bchatsign/blob/main/README.md#developer-setup) for more setup details.
