# Agent Guidelines for Bchatsign
...
- `npm run test:dev -w @bchatsign/app-tests` - Run single E2E test in dev mode
- `npm run test-ui:dev -w @bchatsign/app-tests` - Run E2E tests with UI
