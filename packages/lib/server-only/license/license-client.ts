...
const LICENSE_KEY = env('NEXT_PRIVATE_BCHATSIGN_LICENSE_KEY');
const LICENSE_SERVER_URL = env('INTERNAL_OVERRIDE_LICENSE_SERVER_URL') || 'https://license.bchatsign.com';

declare global {
  // eslint-disable-next-line no-var
  var __bchatsign_license_client__: LicenseClient | undefined;
}
...
export class LicenseClient {
  ...
  public static async start(): Promise<void> {
    if (globalThis.__bchatsign_license_client__) {
      return;
    }
    ...
    globalThis.__bchatsign_license_client__ = instance;
  ...
  public static getInstance(): LicenseClient | null {
    return globalThis.__bchatsign_license_client__ ?? null;
  }
