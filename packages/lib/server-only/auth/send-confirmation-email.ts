...
import { ConfirmEmailTemplate } from '@bchatsign/email/templates/confirm-email';
...
import { BCHATSIGN_INTERNAL_EMAIL, USER_SIGNUP_VERIFICATION_TOKEN_IDENTIFIER } from '../../constants/email';
