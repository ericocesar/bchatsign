...
declare global {
  ...
  var __bchatsignConversionCircuitOpenedAt: number | null | undefined;
}

export const isCircuitOpen = (): boolean => {
  const openedAt = globalThis.__bchatsignConversionCircuitOpenedAt;
...
export const recordSuccess = (): void => {
  globalThis.__bchatsignConversionCircuitOpenedAt = null;
};

export const recordFailure = (): void => {
  globalThis.__bchatsignConversionCircuitOpenedAt = Date.now();
};
