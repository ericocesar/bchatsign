...
export const OVERFLOW_TEST_FIELDS: OverflowFieldTestData[] = [
  ...
  // Single-line: Row 0-2 (default email meta — API auto-adds overflow: 'auto')
  {
    ...
    page: 2,
    ...calculateSingleLinePosition(0),
    customText: 'example@bchatsign.com',
  },
  {
    type: FieldType.EMAIL,
    fieldMeta: undefined,
    ...
    page: 2,
    ...calculateSingleLinePosition(1),
    customText: 'example+medium-overflow-test@bchatsign.com',
  },
  {
    type: FieldType.EMAIL,
    fieldMeta: undefined,
    ...
    ...calculateSingleLinePosition(2),
    customText:
      'example+maximum-overflow-testing-across-the-page-width-to-verify-text-extends-beyond-field@bchatsign.com',
  },
  // Multi-line 3×3: Row 0 = TA_LEFT (short / medium / long)
  {
    type: FieldType.EMAIL,
  ...
  },
  {
    ...
    page: 2,
    ...calculateMultiLinePosition(0, 1),
    customText: 'example+medium-wrapped-text@bchatsign.com',
  },
  {
    type: FieldType.EMAIL,
    fieldMeta: { type: 'email', textAlign: 'left' },
    ...
    ...calculateMultiLinePosition(0, 2),
    customText:
      'example+this-is-an-extremely-long-email-address-that-is-designed-to-overflow-vertically-out-of-the-field-box-and-extend-well-beyond-the-bottom-of-the-page-to-verify-that-the-vertical-overflow-logic-correctly-handles-text-that-wraps@bchatsign.com',
  },
  // Multi-line 3×3: Row 1 = TA_CENTER (short / medium / long)
  {
    type: FieldType.EMAIL,
