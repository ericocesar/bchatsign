import { unsafe_useEffectOnce } from '@bchatsign/lib/client-only/hooks/use-effect-once';
import { SIGNATURE_CANVAS_DPI, SIGNATURE_MIN_COVERAGE_THRESHOLD } from '@bchatsign/lib/constants/signatures';
