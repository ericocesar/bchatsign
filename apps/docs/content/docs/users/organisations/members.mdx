...
Organisation ownership cannot be transferred through the regular organisation settings. Only a Bchatsign instance administrator can transfer ownership through the admin panel.

If you are using Bchatsign Cloud, contact support to request an ownership transfer. If you are self-hosting, an instance administrator can follow the steps below.
...
<Steps>
  ...
  <Step>
    Sign in or create a Bchatsign account.
  </Step>
  <Step>
