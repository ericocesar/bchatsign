---
title: Email Domains
description: Learn how to create and manage email domains in Bchatsign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default Bchatsign email address.
...
- Access to your Bchatsign organisation as an admin or manager
...
After adding your domain, Bchatsign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Bchatsign email domains settings page and click the "Verify" button.
