---
title: Overview
description: Organisations are the top-level entity in Bchatsign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Bchatsign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Bchatsign dashboard](/organisations/organisations-create.webp)
