...
description: Sign up for Bchatsign and configure your profile.
---
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@bchatsign.com`.
...
<Steps>
  <Step>
    ...
    ![Bchatsign account security page showing security options](/get-started-images/bchatsign-account-security-page.webp)
  ...
  <Step>
    ...
    ![Dialog to enable two-factor authentication with QR code setup](/get-started-images/bchatsign-enable-2-factor-authentication.webp)
  ...
  <Step>
    ...
    ![Passkeys settings page showing registered passkeys](/get-started-images/bchatsign-passkeys-page.webp)
  ...
  <Step>
    ...
    ![Dialog to add a new passkey with name input field](/get-started-images/bchatsign-add-passkey-box.webp)
