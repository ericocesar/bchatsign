...
![Document email settings](/document-signing/bchatsign-document-email-settings.webp)
...
![Editor email settings](/document-signing/bchatsign-editor-email-settings.webp)
...
![Email recipient receives](/document-signing/bchatsign-sign-email.webp)
