...
- **Create one automatically**: Bchatsign creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-bchatsign.webp)
...
```
https://app.bchatsign.com/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-bchatsign.webp)
...
If the recipient has a Bchatsign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public Bchatsign profile:
...
![Bchatsign profile with direct links](/direct-links/bchatsign-profile.webp)
...
```html
<a href="https://app.bchatsign.com/d/your-token">Sign our agreement</a>
```
