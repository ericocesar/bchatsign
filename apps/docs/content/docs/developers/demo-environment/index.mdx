...
description: Use the demo environment to try out the Bchatsign platform and its features.
---
...
You can use it to try out the Bchatsign platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-app.bchatsign.com).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [Bchatsign Discord](https://documen.so/discord) or [GitHub](https://github.com/bchatsign/bchatsign/issues).
