...
description: Learn how to contribute translations to Bchatsign and become part of our community.
---
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/bchatsign/bchatsign/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out Bchatsign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie Bchatsign.</0>"
```
...
Thank you for helping make Bchatsign more accessible to users around the world!
