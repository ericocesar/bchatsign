---
title: Contributing to Bchatsign
description: Learn how to contribute to Bchatsign and become part of our community.
---
...
This guide will help you get started with contributing to Bchatsign.
...
Search the existing [issues](https://github.com/bchatsign/bchatsign/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/bchatsign/bchatsign/pulls) to see if someone else is already working on the same thing.
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate Bchatsign
