...
description: Advanced development tools for debugging field IDs, recipient IDs, coordinates and integrating with the Bchatsign API.
---

## Overview

Developer mode provides additional tools and features to help you integrate and debug Bchatsign.
...
https://app.bchatsign.com/t/<team-url>/documents/<envelope-id>/legacy_editor?devmode=true
```
...
https://app.bchatsign.com/t/<team-url>/documents/<envelope-id>/edit?step=addFields&devmode=true
```
