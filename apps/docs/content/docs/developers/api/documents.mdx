...
<Callout type="warn">
  ...
  see the [OpenAPI Reference](https://openapi.bchatsign.com).
</Callout>

## Overview

[Documents](/docs/users/documents) (called "envelopes" in the API) are the core resource in Bchatsign. You can:
...
```bash
# List all documents
curl -X GET "https://app.bchatsign.com/api/v2/envelope" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"

# Filter by status and paginate

curl -X GET "https://app.bchatsign.com/api/v2/envelope?status=PENDING&page=1&perPage=20" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"

# List only documents (not templates)

curl -X GET "https://app.bchatsign.com/api/v2/envelope?type=DOCUMENT" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"
...
```typescript
const API_TOKEN = process.env.BCHATSIGN_API_TOKEN;
const BASE_URL = 'https://app.bchatsign.com/api/v2';
...
<Tab value="curl">
```bash
curl -X GET "https://app.bchatsign.com/api/v2/envelope/envelope_abc123" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"
```
</Tab>
<Tab value="TypeScript">
...
const response = await fetch(`https://app.bchatsign.com/api/v2/envelope/${envelopeId}`, {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/create" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/create', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
  },
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/update" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/update', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
...
```bash
# Basic send
curl -X POST "https://app.bchatsign.com/api/v2/envelope/distribute" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123"
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/distribute', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
  ...
  "recipients": [
    {
      ...
      "role": "SIGNER",
      "signingOrder": 1,
      "signingUrl": "https://app.bchatsign.com/sign/abc123xyz"
    }
  ]
}
````
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "envelope_abc123"
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/delete', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/get-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
...
<Tab value="TypeScript">
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/get-many', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
...
async function getAllPendingDocuments() {
  ...
  while (hasMore) {
    const response = await fetch(
      `https://app.bchatsign.com/api/v2/envelope?status=PENDING&page=${page}&perPage=100`,
      {
