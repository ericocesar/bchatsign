...
<Tab value="curl">
```bash
curl "https://app.bchatsign.com/api/v2/envelope/recipient/789" \
...
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/recipient/789',
  {
    headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/recipient/create-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/recipient/create-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/recipient/update-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "envelopeId": "clu1abc2def3ghi4jkl",
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/recipient/update-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/recipient/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "recipientId": 789
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/recipient/delete',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope/recipient/create-many', {
  method: 'POST',
  headers: {
    Authorization: 'api_xxxxxxxxxxxxxxxx',
    'Content-Type': 'application/json',
