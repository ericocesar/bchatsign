...
<Tab value="curl">
```bash
curl -X GET "https://app.bchatsign.com/api/v2/envelope/field/456" \
...
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/field/456',
  {
    method: 'GET',
    headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/field/create-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/field/create-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/field/update-many" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "documentId": 123,
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/field/update-many',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/field/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "fieldId": 456
...
```typescript
const response = await fetch(
  'https://app.bchatsign.com/api/v2/envelope/field/delete',
  {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
...
Instead of specifying exact coordinates, you can position fields using placeholder text embedded in your PDF. Include placeholder markers such as `{{signature, r1}}` in your document, and Bchatsign will create fields at those locations when the document is uploaded.
...
async function addSignatureBlock(documentId: number, recipientId: number) {
  ...
  const response = await fetch('https://app.bchatsign.com/api/v2/envelope/field/create-many', {
    method: 'POST',
    headers: {
      Authorization: 'api_xxxxxxxxxxxxxxxx',
      'Content-Type': 'application/json',
