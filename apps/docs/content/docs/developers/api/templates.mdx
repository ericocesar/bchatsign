...
```bash
# List all templates
curl -X GET "https://app.bchatsign.com/api/v2/template" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"

# Filter by type and paginate

curl -X GET "https://app.bchatsign.com/api/v2/template?type=PRIVATE&page=1&perPage=20" \
 -H "Authorization: api_xxxxxxxxxxxxxxxx"
...
<Tab value="curl">
```bash
curl -X GET "https://app.bchatsign.com/api/v2/template/123" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx"
```
</Tab>
<Tab value="TypeScript">
...
const response = await fetch(`https://app.bchatsign.com/api/v2/template/${templateId}`, {
  method: 'GET',
  headers: {
...
```bash
# Create document from template
curl -X POST "https://app.bchatsign.com/api/v2/template/use" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  ...
  "recipients": [
    {
      ...
      "signingUrl": "https://app.bchatsign.com/sign/abc123"
    }
  ]
}
````
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/template/update" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123,
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/template/duplicate" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/template/delete" \
  -H "Authorization: api_xxxxxxxxxxxxxxxx" \
  -H "Content-Type: application/json" \
  -d '{
    "templateId": 123
...
// Share: https://app.bchatsign.com/d/{token}
...
See the [OpenAPI Reference](https://openapi.bchatsign.com) for the full request schema.
