---
title: Manual Setup
description: Manually set up Bchatsign on your machine for local development.
---
...
Follow these steps to set up Bchatsign on your local machine:
...
Fork the [Bchatsign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
npm run prisma:seed -w @bchatsign/prisma
```
...
Access the Bchatsign application by visiting `http://localhost:3000` in your web browser.
