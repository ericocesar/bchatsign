---
title: Solid
description: Embed Bchatsign signing in your Solid application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @bchatsign/embed-solid ```</Tab>
  <Tab value="yarn">``` yarn add @bchatsign/embed-solid ```</Tab>
  <Tab value="pnpm">``` pnpm add @bchatsign/embed-solid ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@bchatsign/embed-solid';
...
```tsx
import { EmbedSignDocument } from '@bchatsign/embed-solid';
