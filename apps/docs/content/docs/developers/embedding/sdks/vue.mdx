---
title: Vue
description: Embed Bchatsign signing in your Vue application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @bchatsign/embed-vue ```</Tab>
  <Tab value="yarn">``` yarn add @bchatsign/embed-vue ```</Tab>
  <Tab value="pnpm">``` pnpm add @bchatsign/embed-vue ```</Tab>
</Tabs>
...
<script setup lang="ts">
  import { EmbedDirectTemplate } from '@bchatsign/embed-vue';
...
```html
<script setup lang="ts">
  import { EmbedSignDocument } from '@bchatsign/embed-vue';
