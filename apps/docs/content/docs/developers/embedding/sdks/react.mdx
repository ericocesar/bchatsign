---
title: React
description: Embed Bchatsign signing in your React application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @bchatsign/embed-react ```</Tab>
  <Tab value="yarn">``` yarn add @bchatsign/embed-react ```</Tab>
  <Tab value="pnpm">``` pnpm add @bchatsign/embed-react ```</Tab>
</Tabs>
