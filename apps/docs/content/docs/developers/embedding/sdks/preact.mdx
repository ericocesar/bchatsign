---
title: Preact
description: Embed Bchatsign signing in your Preact application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @bchatsign/embed-preact ```</Tab>
  <Tab value="yarn">``` yarn add @bchatsign/embed-preact ```</Tab>
  <Tab value="pnpm">``` pnpm add @bchatsign/embed-preact ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@bchatsign/embed-preact';
...
```tsx
import { EmbedSignDocument } from '@bchatsign/embed-preact';
