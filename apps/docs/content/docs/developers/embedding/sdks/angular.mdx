---
title: Angular
description: Embed Bchatsign signing in your Angular application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @bchatsign/embed-angular ```</Tab>
  <Tab value="yarn">``` yarn add @bchatsign/embed-angular ```</Tab>
  <Tab value="pnpm">``` pnpm add @bchatsign/embed-angular ```</Tab>
</Tabs>
...
import { EmbedDirectTemplate } from '@bchatsign/embed-angular';
...
import { EmbedSignDocument } from '@bchatsign/embed-angular';
