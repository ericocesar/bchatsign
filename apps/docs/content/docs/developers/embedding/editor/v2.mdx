...
```jsx
import { EmbedCreateEnvelope } from '@bchatsign/embed-react';
...
```jsx
import { EmbedUpdateEnvelope } from '@bchatsign/embed-react';
...
import { EmbedCreateEnvelope, EmbedUpdateEnvelope } from '@bchatsign/embed-react';
