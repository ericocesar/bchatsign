...
In addition to embedding signing, Bchatsign supports embedded editor. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your Bchatsign API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.bchatsign.com/reference#tag/embedding) for full details.
