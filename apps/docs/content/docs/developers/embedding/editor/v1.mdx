...
```jsx
import { EmbedCreateDocumentV1 } from '@bchatsign/embed-react';
...
```jsx
import { EmbedCreateTemplateV1 } from '@bchatsign/embed-react';
...
```jsx
import { EmbedUpdateDocumentV1 } from '@bchatsign/embed-react';
...
```jsx
import { EmbedUpdateTemplateV1 } from '@bchatsign/embed-react';
...
| `host`             | `string`  | No       | Custom host URL. Defaults to `https://app.bchatsign.com` |
...
| `language`         | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/bchatsign/bchatsign/tree/main/packages/lib/constants/locales.ts) |
...
import { EmbedCreateDocumentV1, EmbedUpdateDocumentV1 } from '@bchatsign/embed-react';
