...
description: Create and send a document for signing using the Bchatsign API, from uploading a PDF to adding recipients and distributing for signature.
---
...
- A Bchatsign account (cloud or self-hosted)
...
| ----------- | -------------------------------------- |
| Production  | `https://app.bchatsign.com/api/v2`     |
| Staging     | `https://stg-app.bchatsign.com/api/v2` |
...
```javascript
const response = await fetch('https://app.bchatsign.com/api/v2/envelope', {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.bchatsign.com/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://app.bchatsign.com/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://app.bchatsign.com/api/v2"
...
- [API Reference](https://openapi.bchatsign.com/) - Full endpoint documentation with request/response schemas
...
- [TypeScript SDK](https://github.com/bchatsign/sdk-typescript)
- [Python SDK](https://github.com/bchatsign/sdk-python)
- [Go SDK](https://github.com/bchatsign/sdk-go)
