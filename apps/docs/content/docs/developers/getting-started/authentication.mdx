...
- A Bchatsign account on any plan (Free, Individual, Team, or Enterprise)
...
- Log in to your Bchatsign account
- Click your avatar in the top right corner
- Select **Settings** from the dropdown menu

![User dropdown menu](/public-api-images/bchatsign-user-dropdown-menu.webp)
...
![API tokens page](/public-api-images/api-tokens-page-bchatsign.webp)
...
![API key display](/public-api-images/bchatsign-api-key-blurred.webp)
...
```bash
curl https://app.bchatsign.com/api/v2/document \
...
```typescript
const response = await fetch('https://app.bchatsign.com/api/v2/document', {
  method: 'GET',
  headers: {
...
Bchatsign provides official SDKs that handle authentication for you:

```typescript
import { Bchatsign } from '@bchatsign/sdk-typescript';

const client = new Bchatsign({
...
SDKs are available for [TypeScript](https://github.com/bchatsign/sdk-typescript), [Python](https://github.com/bchatsign/sdk-python), and [Go](https://github.com/bchatsign/sdk-go).
...
<Callout type="info">
  ...
  OpenAPI reference](https://app.bchatsign.com/api/v1/openapi).
</Callout>
...
BCHATSIGN_API_KEY=api_xxxxxxxxxxxxxxxx
```

```typescript
const client = new Bchatsign({
  apiKey: process.env.BCHATSIGN_API_KEY,
});
```
