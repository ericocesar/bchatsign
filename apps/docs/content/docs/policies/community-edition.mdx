...
description: The open-source version of Bchatsign, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
The full license text is available in the [LICENSE file](https://github.com/bchatsign/bchatsign/blob/main/LICENSE) in the repository.
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run Bchatsign for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify Bchatsign and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      Bchatsign instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate Bchatsign code are subject to AGPL-3.0
...
The Community Edition includes the core Bchatsign functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The Bchatsign Discord server is the primary community support channel. You can:
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/bchatsign/bchatsign/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/bchatsign/bchatsign/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and Bchatsign team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to Bchatsign are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [Bchatsign repository](https://github.com/bchatsign/bchatsign)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/bchatsign/bchatsign/blob/main/CONTRIBUTING.md) file in the repository
