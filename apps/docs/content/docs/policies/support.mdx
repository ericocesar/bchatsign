...
Join the Bchatsign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other Bchatsign users
...
- **[GitHub Discussions](https://github.com/bchatsign/bchatsign/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/bchatsign/bchatsign/issues)**: Report confirmed bugs with reproducible steps
...
Paid plans include access to direct support from the Bchatsign team.
...
- Email support at support@bchatsign.com
- Account and billing assistance
- Technical guidance for Bchatsign Cloud usage
...
- Private Discord channel for direct communication with the Bchatsign team
...
- [GitHub Discussions](https://github.com/bchatsign/bchatsign/discussions) - Community Q&A
...
- Guidance on Bchatsign features and functionality
...
For billing disputes or account issues, email support@bchatsign.com with your account details.
...
Bchatsign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@bchatsign.com                                          |
| Security issues  | security@bchatsign.com                                         |
| Enterprise sales | [sales@bchatsign.com](https://documen.so/enterprise)           |
| Privacy requests | privacy@bchatsign.com                                          |
| Community        | [Discord](https://documen.so/discord)                          |
| Bug reports      | [GitHub Issues](https://github.com/bchatsign/bchatsign/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How Bchatsign handles your data
