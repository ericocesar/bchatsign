---
title: Security
description: Security practices for Bchatsign Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/bchatsign/bchatsign](https://github.com/bchatsign/bchatsign)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from Bchatsign is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    Bchatsign encrypts sensitive data at the application level:
...
Bchatsign operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@bchatsign.com**
...
- [GitHub releases](https://github.com/bchatsign/bchatsign/releases)
- [GitHub security advisories](https://github.com/bchatsign/bchatsign/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/bchatsign/bchatsign) for releases
...
When self-hosting Bchatsign, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@bchatsign.com
- **General questions**: support@bchatsign.com
- **GitHub**: [github.com/bchatsign/bchatsign](https://github.com/bchatsign/bchatsign)
