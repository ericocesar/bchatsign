...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate Bchatsign into proprietary products.
---
...
- **Build proprietary products**: Integrate Bchatsign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to Bchatsign source code that you don't want to disclose

<Callout type="info">
  If you run Bchatsign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using Bchatsign API only        | Community Edition  |
| SaaS product with modified Bchatsign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed Bchatsign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute Bchatsign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    2. Access your license key at [license.bchatsign.com](https://license.bchatsign.com)
    3. Set the environment variable:

    ```bash
    NEXT_PRIVATE_BCHATSIGN_LICENSE_KEY="your-license-key-here"
    ```

    4. Restart your Bchatsign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and Bchatsign. Key terms include:

    - **Scope**: License to use, modify, and distribute Bchatsign as specified in your agreement
    - **Exclusions**: The license does not grant rights to Bchatsign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - Bchatsign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or Bchatsign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@bchatsign.com](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating Bchatsign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access Bchatsign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include Bchatsign Cloud?">
