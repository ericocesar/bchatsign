---
title: GDPR
description: Understand how Bchatsign handles GDPR compliance for data processing and storage.
---
...
When using Bchatsign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using Bchatsign) determine the purposes and means of processing |
| **Data Processor**  | Bchatsign processes personal data on your behalf according to your instructions       |
...
As the data processor, Bchatsign:
...
Bchatsign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use Bchatsign:

<Tabs items={['Bchatsign Cloud', 'Self-Hosted']}>
<Tab value="Bchatsign Cloud">
...
Contact Bchatsign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host Bchatsign:

- You control all data storage locations
- No data is transmitted to Bchatsign's infrastructure
...
- Export user and document data from your Bchatsign account
- Delete user accounts and associated documents
- Contact Bchatsign support for assistance with cloud-hosted data

## Data Deletion

Bchatsign supports data deletion to help fulfill erasure requests:
...
Self-hosting Bchatsign can simplify GDPR compliance:
...
- Contact [support@bchatsign.com](mailto:support@bchatsign.com) to request a DPA
- The DPA covers Bchatsign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with Bchatsign is required since no personal data is processed by Bchatsign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use Bchatsign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy Bchatsign on your own infrastructure
