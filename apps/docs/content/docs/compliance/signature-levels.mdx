...
<Callout type="info">
  Bchatsign seals all signed documents cryptographically, regardless of signature level, to prevent
...
<Callout type="warn">
  Status: [Planned](https://github.com/bchatsign/backlog/issues/9) via third party until [Let's
  Sign](https://github.com/bchatsign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/bchatsign/backlog/issues/32) via third party until [Let's
  Sign](https://github.com/bchatsign/backlog/issues/21) is realized.
</Callout>
...
## What Bchatsign Provides

Bchatsign supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What Bchatsign Does Not Provide
...
<Callout type="warn">Status: [Planned](https://github.com/bchatsign/backlog/issues/34)</Callout>
