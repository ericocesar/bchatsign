---
title: Self-Hosting
description: Deploy and manage your own Bchatsign instance for complete control over your data, compliance, and customization.
---
...
<Callout type="error">
  **You must generate a signing certificate.** Bchatsign does not ship with one. Without a
...
Get Bchatsign running locally in under 5 minutes:
...
Self-hosted Bchatsign includes full core functionality under the AGPL-3.0 license. If you need enterprise features such as SSO, embed editor white label, or 21 CFR Part 11 compliance, you can activate them with a license key.
...
<Cards>
  <Card
    title="User Guide"
    description="Learn how to use Bchatsign for document signing."
    href="/docs/users"
  />
  <Card
    title="Developer Guide"
    description="Integrate Bchatsign into your applications using the API."
