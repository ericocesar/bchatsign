...
Create a service account with the `cloudkms.signerVerifier` role so Bchatsign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; Bchatsign needs it to embed in signatures.
...
NEXT_PRIVATE_SIGNING_GCLOUD_HSM_KEY_PATH=projects/my-project/locations/global/keyRings/bchatsign/cryptoKeys/signing-key/cryptoKeyVersions/1
NEXT_PRIVATE_SIGNING_GCLOUD_HSM_PUBLIC_CRT_FILE_PATH=/opt/bchatsign/public.crt
