...
description: Learn how to set up OAuth providers for your own instance of Bchatsign.
---
...
- **Authorized JavaScript origins**: `https://<bchatsign-domain>`
- **Authorized redirect URIs**: `https://<bchatsign-domain>/api/auth/callback/google`

</Step>
<Step>
### Set environment variables

In your Bchatsign environment, set:
...
```bash
https://<bchatsign-domain>/api/auth/callback/microsoft
```
