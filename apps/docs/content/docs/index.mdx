...
<div className="not-prose max-w-4xl mx-auto px-4">
  ...
  <div className="rounded-xl border bg-gradient-to-r from-fd-primary/5 to-fd-primary/10 p-6 text-center">
    ...
    <div className="flex flex-wrap justify-center gap-3">
      <a href="https://github.com/bchatsign/bchatsign" className="inline-flex items-center gap-2 rounded-lg bg-fd-background border px-4 py-2 text-sm font-medium hover:bg-fd-accent transition-colors">
      ...
      <a href="https://bchatsign.com" className="inline-flex items-center gap-2 rounded-lg bg-fd-primary text-fd-primary-foreground px-4 py-2 text-sm font-medium hover:bg-fd-primary/90 transition-colors">
        Try Bchatsign
      </a>
    </div>
  </div>
