...
export const metadata: Metadata = {
  title: 'Bchatsign Docs',
  description:
    'The official documentation for Bchatsign, the open-source document signing platform. Send documents for signatures, integrate with the API, or self-host with full control.',
};
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-16 pt-6 text-center">
        <h1 className="mb-4 font-bold text-4xl tracking-tight">Bchatsign Documentation</h1>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            href="/docs/users"
            className="inline-flex items-center gap-2 rounded-lg bg-bchatsign px-5 py-2.5 font-medium text-fd-primary-foreground text-sm transition-colors hover:bg-bchatsign-dark/90"
          >
            Get Started
          </Link>
          <a
            href="https://github.com/bchatsign/bchatsign"
      ...
      <div className="mb-16 grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <p className="mb-4 flex-1 text-fd-muted-foreground text-sm">
            Deploy your own Bchatsign instance with Docker, Kubernetes, or Railway.
          </p>
      ...
      <div className="rounded-xl border bg-gradient-to-r from-fd-primary/5 to-fd-primary/10 p-8 text-center">
        ...
        <p className="mb-6 text-fd-muted-foreground text-sm">
          Bchatsign is open source. Contribute, ask questions, or share feedback.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          <a
            href="https://github.com/bchatsign/bchatsign"
          ...
          <a
            href="https://app.bchatsign.com/signup"
            className="inline-flex items-center gap-2 rounded-lg bg-bchatsign px-4 py-2 font-medium text-fd-primary-foreground text-sm transition-colors hover:bg-bchatsign/90"
          >
            Try Bchatsign
          </a>
        </div>
