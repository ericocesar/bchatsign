  ...
  return (
    <main className="mx-auto flex max-w-xl flex-col items-center justify-center px-4 py-32 text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Link
          href="/docs/users"
          className="inline-flex items-center rounded-lg bg-bchatsign px-5 py-2.5 font-medium text-fd-primary-foreground text-sm transition-colors hover:bg-bchatsign/90"
        >
