import type { TNumberFieldMeta } from '@bchatsign/lib/types/field-meta';
...
import { numberFormatValues } from '@bchatsign/ui/primitives/document-flow/field-items-advanced-settings/constants';
