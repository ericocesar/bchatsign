import type { ImageLoadingState, PageRenderData } from '@bchatsign/lib/client-only/providers/envelope-render-provider';
import { PDF_VIEWER_PAGE_CLASSNAME } from '@bchatsign/lib/constants/pdf-viewer';
