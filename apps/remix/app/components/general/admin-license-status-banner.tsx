        ...
        <div className="flex items-center">
          ...
          {match(licenseStatus)
            ...
            .with('UNAUTHORIZED', () =>
              license ? (
                <Trans>
                  Invalid License Type - Your BchatSign instance is using features that are not part of your license.
                </Trans>
              ) : (
                <Trans>Missing License - Your BchatSign instance is using features that require a license.</Trans>
              ),
            )
            .otherwise(() => null)}
        </div>
