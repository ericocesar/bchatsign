import type { TLocalField } from '@bchatsign/lib/client-only/hooks/use-editor-fields';
...
import {
  ...
  MIN_FIELD_HEIGHT_PX,
  MIN_FIELD_WIDTH_PX,
} from '@bchatsign/lib/universal/field-renderer/field-renderer';
...
import { CommandDialog } from '@bchatsign/ui/primitives/command';
