...
import { useEnvelopeAutosave } from '@bchatsign/lib/client-only/hooks/use-envelope-autosave';
...
import type { TReplaceEnvelopeItemPdfPayload } from '@bchatsign/trpc/server/envelope-router/replace-envelope-item-pdf.types';
...
import { DocumentDropzone } from '@bchatsign/ui/primitives/document-dropzone';
