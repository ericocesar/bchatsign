...
import { getPublicProfileByUrl } from '@bchatsign/lib/server-only/profile/get-public-profile-by-url';
          ...
          <p className="max-w-[60ch] whitespace-pre-wrap break-words text-center text-muted-foreground text-sm leading-relaxed">
            ...
            {!user?.id && (
              <span className="mt-2 inline-block">
                <Trans>
                  While waiting for them to do so you can create your own BchatSign account and get started with
