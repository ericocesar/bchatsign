...
import { ZUpdateOrganisationAuthenticationPortalRequestSchema } from '@bchatsign/trpc/server/enterprise-router/update-organisation-authentication-portal.types';
