  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using BchatSign to perform your electronic document signing. The purpose of this disclosure is
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by BchatSign, you affirm that you have read
